                    ...
                    >
                      ...
                      <div className="bg-white/5 rounded-xl p-6 md:p-8 hover:bg-white/10 transition-colors">
                        ...
                        <div className="mb-4">
                          ...
                          <span className="inline-flex items-center px-2 py-1 rounded-full text-xs md:text-sm font-medium bg-white/10 text-white/80 mt-2">
